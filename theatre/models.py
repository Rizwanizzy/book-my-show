...
class Theatre_Sale_Report(models.Model):
    ...
    theatre_earnings=models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
...
class Admin_Sale_Report(models.Model):
    name=models.CharField(max_length=255,default=None)
    theatre_sale_report=models.ForeignKey(Theatre_Sale_Report,on_delete=models.CASCADE)
